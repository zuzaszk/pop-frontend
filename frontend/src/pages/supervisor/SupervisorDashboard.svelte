<script>
  ...
  async function fetchStatistics() {
    try {
      const url = `http://192.168.0.107:8080/zpi/statistic/getCounts`;
  ...
  async function fetchAverageEvaluationScore() {
    try {
      const url = `http://192.168.0.107:8080/zpi/statistic/averageGrades?n=1`;
      const response = await fetch(url);
      const result = await response.json();
  ...
  async function fetchChartData() {
    try {
      errorMessage = "";
      const url = `http://192.168.0.107:8080/zpi/statistic/topTechnologies`;
      const response = await fetch(url);
      const result = await response.json();
  ...
  async function fetchLinearChartData() {
    try {
      linearChartError = "";
      const url = `http://192.168.0.107:8080/zpi/statistic/averageGrades?n=${yearsInput}`;
      const response = await fetch(url);
      const result = await response.json();
