<script>
  ...
  async function loginWithEmail() {
    ...
    try {
      ...
      const response = await fetch("http://192.168.0.107:8080/auth/login", {
        method: "POST",
  ...
  function loginWithGoogle() {
    console.log(
      "Redirecting to:",
      "http://192.168.0.107:8080/oauth2/authorization/google"
    );
  ...
  function loginWithFacebook() {
    window.location.href =
      "http://192.168.0.107:8080/oauth2/authorization/facebook";
  }
